...
export default function AccountCard({ account, isActive, onActivate }: Props) {
  return (
    <Link href={`/dashboard/accounts/${account.id}`} className="block hover:shadow-lg transition-shadow rounded-lg">
      <Card className={cn("h-full flex flex-col justify-between", isActive && "border-primary ring-2 ring-primary")}>
